! function (e, t) {
    ...
    ! function () {
        ...
        t.prototype.init = function () {
            ...
            if (this.s.controls && this.$items.length > 1 && (o = '<div class="lg-actions"><button class="lg-prev lg-icon">' + this.s.prevHtml + '</button><button class="lg-next lg-icon">' + this.s.nextHtml + "</button></div>"), ".lg-sub-html" === this.s.appendSubHtmlTo && (a = '<div class="lg-sub-html"></div>'), t = '<div class="lg-outer ' + this.s.addClass + " " + this.s.startClass + '"><div class="lg" style="width:' + this.s.width + "; height:" + this.s.height + '"><div class="lg-inner">' + s + '</div><a href="https://calderaspas.com" target="_blank" class="lg-icon " id="lg-link-home">&nbsp;</a><div class="lg-toolbar lg-group"><a  href="https://calderaspas.com/caldera-brochure/" target="_blank" download><span class="lg-pdf lg-icon"></span></a></div>' + o + a + "</div></div>", e("body").append(t), this.$outer = e(".lg-outer"), this.$slide = this.$outer.find(".lg-item"), this.s.useLeft ? (this.$outer.addClass("lg-use-left"), this.s.mode = "lg-slide") : this.$outer.addClass("lg-use-css3"), r.setTop(), e(window).on("resize.lg orientationchange.lg", function () {
                    setTimeout(function () {
                        r.setTop()
                    }, 100)
            ...
            var i, a, r, l, n, d, c = this,
                ...
                h = function (t) {
                    ...
                    for (var l = e(window).width(), n = 0; n < s.length; n++)
                        if (parseInt(s[n], 10) > l) {
                            a = o[n];
                            break
                        }
                };
            c.s.dynamic ? (c.s.dynamicEl[t].poster && (u = !0, r = c.s.dynamicEl[t].poster), d = c.s.dynamicEl[t].html, a = c.s.dynamicEl[t].src, c.s.dynamicEl[t].responsive && h(c.s.dynamicEl[t].responsive.split(",")), l = c.s.dynamicEl[t].srcset, n = c.s.dynamicEl[t].sizes) : (c.$items.eq(t).attr("data-poster") && (u = !0, r = c.$items.eq(t).attr("data-poster")), d = c.$items.eq(t).attr("data-html"), a = c.$items.eq(t).attr("href") || c.$items.eq(t).attr("data-src"), c.$items.eq(t).attr("data-responsive") && h(c.$items.eq(t).attr("data-responsive").split(",")), l = c.$items.eq(t).attr("data-srcset"), n = c.$items.eq(t).attr("data-sizes"));
            var g = !1;
            ...
            if (!c.$slide.eq(t).hasClass("lg-loaded")) {
                if (g) c.$slide.eq(t).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>');
                    ...
                    var p = "";
                    p = m && m.youtube ? "lg-has-youtube" : m && m.vimeo ? "lg-has-vimeo" : "lg-has-html5", c.$slide.eq(t).prepend('<div class="lg-video-cont ' + p + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + r + '" /></div></div>')
                ...
                if (c.$el.trigger("onAferAppendSlide.lg", [t]), i = c.$slide.eq(t).find(".lg-object"), n && i.attr("sizes", n), l) {
                    i.attr("srcset", l);
                    try {
                        picturefill({
                            elements: [i[0]]
            ...
            var a = this.$outer.find(".lg-current").index(),
                r = this;
            if (!r.lGalleryOn || a !== t) {
                var l, n, d, c = this.$slide.length,
                    u = r.lGalleryOn ? this.s.speed : 0;
                if (!r.lgBusy) this.s.download && ((l = r.s.dynamic ? !1 !== r.s.dynamicEl[t].downloadUrl && (r.s.dynamicEl[t].downloadUrl || r.s.dynamicEl[t].src) : "false" !== r.$items.eq(t).attr("data-download-url") && (r.$items.eq(t).attr("data-download-url") || r.$items.eq(t).attr("href") || r.$items.eq(t).attr("data-src"))) ? (e("#lg-download").attr("href", l), r.$outer.removeClass("lg-hide-download")) : r.$outer.addClass("lg-hide-download")), this.$el.trigger("onBeforeSlide.lg", [a, t, s, o]), r.lgBusy = !0, clearTimeout(r.hideBartimeout), ".lg-sub-html" === this.s.appendSubHtmlTo && setTimeout(function () {
                    r.addHtml(t)
                    ...
                    r.lgBusy = !1, r.$el.trigger("onAfterSlide.lg", [a, t, s, o])
                }, this.s.speed)) : (r.loadContent(t, !0, r.s.backdropDuration), r.lgBusy = !1, r.$el.trigger("onAfterSlide.lg", [a, t, s, o])), r.lGalleryOn = !0, this.s.counter && e("#lg-counter-current").text(t + 1);
                r.index = t
            }
            ...
            t.s.enableDrag && t.doCss() && (t.$slide.on("mousedown.lg", function (o) {
                ...
                a ? (a = !1, t.touchEnd(o - s), t.$el.trigger("onDragend.lg")) : (e(r.target).hasClass("lg-object") || e(r.target).hasClass("lg-video-play")) && t.$el.trigger("onSlideClick.lg"), i && (i = !1, t.$outer.removeClass("lg-grabbing").addClass("lg-grab"))
            }))
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            if (i.core.$outer.find(".lg").append('<div class="lg-pager-outer"></div>'), i.core.s.dynamic)
                for (var r = 0; r < i.core.s.dynamicEl.length; r++) a += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + i.core.s.dynamicEl[r].thumb + '" /></div></span>';
...
function (e, t) {
    ...
    ! function () {
        ...
        s.prototype.init = function () {
            ...
            function t(e, t, s) {
                var r, l = o.core.isVideo(e, s) || {},
                    n = "";
                l.youtube || l.vimeo || l.dailymotion ? l.youtube ? r = o.core.s.loadYoutubeThumbnail ? "//img.youtube.com/vi/" + l.youtube[1] + "/" + o.core.s.youtubeThumbSize + ".jpg" : t : l.vimeo ? o.core.s.loadVimeoThumbnail ? (r = "//i.vimeocdn.com/video/error_" + a + ".jpg", n = l.vimeo[1]) : r = t : l.dailymotion && (r = o.core.s.loadDailymotionThumbnail ? "//www.dailymotion.com/thumbnail/video/" + l.dailymotion[1] : t) : r = t, i += '<div data-vimeo-id="' + n + '" class="lg-thumb-item" style="width:' + o.core.s.thumbWidth + "px; height: " + o.core.s.thumbHeight + "; margin-right: " + o.core.s.thumbMargin + 'px"><img src="' + r + '" /></div>', n = ""
            }
            var s, o = this,
                i = "",
                a = "",
            ...
            if (o.core.$outer.addClass("lg-has-thumb"), o.core.$outer.find(".lg").append(r), o.$thumbOuter = o.core.$outer.find(".lg-thumb-outer"), o.thumbOuterWidth = o.$thumbOuter.width(), o.core.s.animateThumb && o.core.$outer.find(".lg-thumb").css({
                    width: o.thumbTotalWidth + "px",
                    position: "relative"
                }), this.core.s.animateThumb && o.$thumbOuter.css("height", o.core.s.thumbContHeight + "px"), o.core.s.dynamic)
                for (var l = 0; l < o.core.s.dynamicEl.length; l++) t(o.core.s.dynamicEl[l].src, o.core.s.dynamicEl[l].thumb, l);
            ...
            t.$thumbOuter.addClass("lg-grab"), t.core.$outer.find(".lg-thumb").on("mousedown.lg.thumb", function (e) {
                ...
                i && (r = t.left, a = !0, o = e.pageX, t.$thumbOuter.addClass("lg-dragging"), (r -= o - s) > t.thumbTotalWidth - t.thumbOuterWidth && (r = t.thumbTotalWidth - t.thumbOuterWidth), r < 0 && (r = 0), t.setTranslate(r))
            }), e(window).on("mouseup.lg.thumb", function () {
                a ? (a = !1, t.$thumbOuter.removeClass("lg-dragging"), t.left = r, Math.abs(o - s) < t.core.s.swipeThreshold && (t.thumbClickable = !0)) : t.thumbClickable = !0, i && (i = !1, t.$thumbOuter.removeClass("lg-grabbing").addClass("lg-grab"))
            })
...
function (e, t) {
    ...
    ! function () {
        ...
        a.prototype.init = function () {
            ...
            if (o && (l = this.videoLoaded ? 0 : this.core.s.autoplayFirstVideo ? 1 : 0), d.youtube) n = "?wmode=opaque&autoplay=" + l + "&enablejsapi=1", this.core.s.youtubePlayerParams && (n = n + "&" + e.param(this.core.s.youtubePlayerParams)), r = '<iframe class="lg-video-object lg-youtube ' + s + '" width="560" height="315" src="//www.youtube.com/embed/' + d.youtube[1] + n + '" frameborder="0" allowfullscreen></iframe>';
            else if (d.vimeo) n = "?autoplay=" + l + "&api=1", this.core.s.vimeoPlayerParams && (n = n + "&" + e.param(this.core.s.vimeoPlayerParams)), r = '<iframe class="lg-video-object lg-vimeo ' + s + '" width="560" height="315"  src="//player.vimeo.com/video/' + d.vimeo[1] + n + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
            else if (d.dailymotion) n = "?wmode=opaque&autoplay=" + l + "&api=postMessage", this.core.s.dailymotionPlayerParams && (n = n + "&" + e.param(this.core.s.dailymotionPlayerParams)), r = '<iframe class="lg-video-object lg-dailymotion ' + s + '" width="560" height="315" src="//www.dailymotion.com/embed/video/' + d.dailymotion[1] + n + '" frameborder="0" allowfullscreen></iframe>';
            else if (d.html5) {
                var c = a.substring(0, 1);
                "." !== c && "#" !== c || (a = e(a).html()), r = a
            } else d.vk && (n = "&autoplay=" + l, this.core.s.vkPlayerParams && (n = n + "&" + e.param(this.core.s.vkPlayerParams)), r = '<iframe class="lg-video-object lg-vk ' + s + '" width="560" height="315" src="//vk.com/video_ext.php?' + d.vk[1] + n + '" frameborder="0" allowfullscreen></iframe>');
            return r
        ...
        s.prototype.init = function () {
            ...
            var o = 1,
                ...
                r = function (s, i, r, l) {
                    ...
                    n = t.core.s.dynamic ? t.core.s.dynamicEl[r].width || i[0].naturalWidth || d : t.core.$items.eq(r).attr("data-width") || i[0].naturalWidth || d, t.core.$outer.hasClass("lg-zoomed") ? o = 1 : n > d && (o = n / d || 2), l ? (t.pageX = e(window).width() / 2, t.pageY = e(window).height() / 2 + e(window).scrollTop()) : (t.pageX = s.pageX || s.originalEvent.targetTouches[0].pageX, t.pageY = s.pageY || s.originalEvent.targetTouches[0].pageY), a(), setTimeout(function () {
            ...
            t.core.$el.on("onAferAppendSlide.lg.tm.zoom", function (e, s) {
                ...
                o.on("dblclick", function (e) {
                    ...
                    l ? (clearTimeout(l), l = null, r(e, o, s)) : l = setTimeout(function () {
                        l = null
            ...
            e.core.$slide.on("touchstart.lg", function (s) {
                ...
                if (e.core.$outer.hasClass("lg-zoomed")) {
                    var l, n, d = e.core.$slide.eq(e.core.index).find(".lg-img-wrap");
                    r.preventDefault(), o = !0, s = {
                        x: r.originalEvent.targetTouches[0].pageX,
                        y: r.originalEvent.targetTouches[0].pageY
                    }, e.core.$outer.addClass("lg-zoom-dragging"), n = a ? -Math.abs(d.attr("data-y")) + (s.y - t.y) : -Math.abs(d.attr("data-y")), l = i ? -Math.abs(d.attr("data-x")) + (s.x - t.x) : -Math.abs(d.attr("data-x")), (Math.abs(s.x - t.x) > 15 || Math.abs(s.y - t.y) > 15) && (e.core.s.useLeftForZoom ? d.css({
                        left: l + "px",
                        top: n + "px"
                    }) : d.css("transform", "translate3d(" + l + "px, " + n + "px, 0)"))
                }
            ...
            t.core.$slide.on("mousedown.lg.zoom", function (o) {
                ...
                l = a.prop("offsetHeight") * a.attr("data-scale") > t.core.$outer.find(".lg").height(), r = a.prop("offsetWidth") * a.attr("data-scale") > t.core.$outer.find(".lg").width(), t.core.$outer.hasClass("lg-zoomed") && e(o.target).hasClass("lg-object") && (r || l) && (o.preventDefault(), s = {
                    x: o.pageX,
                    y: o.pageY
                ...
                if (i) {
                    ...
                    a = !0, o = {
                        x: e.pageX,
                        y: e.pageY
                    }, t.core.$outer.addClass("lg-zoom-dragging"), d = l ? -Math.abs(c.attr("data-y")) + (o.y - s.y) : -Math.abs(c.attr("data-y")), n = r ? -Math.abs(c.attr("data-x")) + (o.x - s.x) : -Math.abs(c.attr("data-x")), t.core.s.useLeftForZoom ? c.css({
                        left: n + "px",
                        top: d + "px"
                ...
                i && (i = !1, t.core.$outer.removeClass("lg-zoom-dragging"), !a || s.x === o.x && s.y === o.y || (o = {
                    x: e.pageX,
                    y: e.pageY
                }, t.touchendZoom(s, o, r, l)), a = !1), t.core.$outer.removeClass("lg-grabbing").addClass("lg-grab")
            })
            ...
            var i = this,
                ...
                l = -Math.abs(a.attr("data-x")) + (t.x - e.x),
            ...
            (Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) && (o && (n <= -c ? n = -c : n >= -d && (n = -d)), s && (l <= -h ? l = -h : l >= -u && (l = -u)), o ? a.attr("data-y", Math.abs(n)) : n = -Math.abs(a.attr("data-y")), s ? a.attr("data-x", Math.abs(l)) : l = -Math.abs(a.attr("data-x")), i.core.s.useLeftForZoom ? a.css({
                left: l + "px",
                top: n + "px"
            }) : a.css("transform", "translate3d(" + l + "px, " + n + "px, 0)"))
        }, s.prototype.destroy = function () {
            var t = this;
